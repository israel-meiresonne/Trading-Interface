...
from model.structure.strategies.Solomon.Solomon import Solomon
...
class Draft(Order, Hand):
    ...
    def download_market_histories() -> None:
        ...
        endtime =   int(_MF.date_to_unix('2023-01-01 00:00:00'))
    ...
    @classmethod
    def backtest2(cls, strategy_class: Strategy = None, pair: Pair = None, starttime: int = None, endtime: int = None) -> None:
    ...
    def loop_backtest2(cls) -> None:
        ...
        # Vars
        file_path = 'jupiter/2023-01-07_20.06.31_top_keltner_roi.csv'
...
# nohup echo $(echo 'No!backtest2!Record!January_2021_January_2022' | sed 's#!#\n#g' | sh start_draft.sh 2>&1) &!

# echo 'No!Record!backtest2!Solomon!13_14_February_2021!COCOS/USDT' | sed 's#!#\n#g' | sh start_draft.sh
# du -hs $(ls -1 ./ | grep -v '2023-01-06_07.12.55_Solomon-v1.1.3') 
# du -hs $(ls -1 2023*/view/ | grep -E ':$' | sed 's#:##' | grep -v '2023-01-06_07.12.55_Solomon-v1.1.3')

# rm -fr $(ls -1 2023*/view | grep -E ':$' | sed 's#:##' | grep -v '2023-01-06_07.12.55_Solomon-v1.1.3')
# tail -n 1 content/sessions/running/*/view/model/*_model_output.txt | grep '|MainThread|' && ps -A | grep 'draft.py'

# echo 'No!Print!loop_backtest2!Solomon!January_2021_January_2023' | sed 's#!#\n#g' | sh start_draft.sh
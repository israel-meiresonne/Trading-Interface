...
DIR_BEGIN_BACKUP = f'content/v0.01/tests/{START_DATE}/{START_DATE}_a_a————————————————————.csv'
DIR_SAVE_BOT_ERRORS = f'content/v0.01/tests/{START_DATE}/{START_DATE}_b_bot_error.csv'
DIR_SAVE_FAKE_API_RQ = f'content/v0.01/tests/{START_DATE}/{START_DATE}_c_logs.csv'
DIR_SAVE_API_RSP = f'content/v0.01/tests/{START_DATE}/{START_DATE}_d_broker_response.csv'
DIR_SAVE_MARKET = f'content/v0.01/tests/{START_DATE}/{START_DATE}_e_market_historic.csv'
DIR_SAVE_MARKET_STALK = f'content/v0.01/tests/{START_DATE}/{START_DATE}_f_market_stalk.csv'
DIR_SAVE_GLOBAL_STATE = f'content/v0.01/tests/{START_DATE}/{START_DATE}_fa_global_capital.csv'
DIR_SAVE_GLOBAL_MOVES = f'content/v0.01/tests/{START_DATE}/{START_DATE}_fb_$class_moves.csv'
DIR_SAVE_CAPITAL = f'content/v0.01/tests/{START_DATE}/{START_DATE}_g_capital_$pair.csv'
DIR_SAVE_MOVES = f'content/v0.01/tests/{START_DATE}/{START_DATE}_h_moves_$pair.csv'
DIR_SAVE_ORDER_RQ = f'content/v0.01/tests/{START_DATE}/{START_DATE}_i_submitted_orders.csv'
DIR_SAVE_ORDER_ACTIONS = f'content/v0.01/tests/{START_DATE}/{START_DATE}_j_order_updates_$pair.csv'
DIR_SAVE_PERIOD_RANKING = f'content/v0.01/tests/{START_DATE}/{START_DATE}_k_period_ranking_$pair.csv'
DIR_END_BACKUP = f'content/v0.01/tests/{START_DATE}/{START_DATE}_z————————————————————.csv'
